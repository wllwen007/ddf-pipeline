...
option_list = ( ( 'machine', 'NCPU_DDF', int, getcpus(),
                ...
                ( 'control', 'skip_di', bool, False, 'If True, skip the DI calibration steps (used for LBA)' ),
                ( 'control', 'phaseonly', bool, False, 'If True, do not apply amplitudes until the final very slow step (used for LBA)' ),
                ...
                ( 'control', 'redo_DI', bool, False, 'Redo DI cal with DPPP' ),
